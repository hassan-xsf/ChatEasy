...
function MainChat() {
    ...
    return <>
        <div className="bg-white w-[80%] h-[calc(98vh-8vh)] sm:h-[calc(80vh-8vh)] lg:h-[calc(75vh-7vh)] relative">
            ...
            {
                emoji &&
                <div className="w-[90%] flex flex-col overflow-y-auto p-2 h-36 bg-white ring-1 ring-primary ring-opacity-50 absolute bottom-12 left-5 rounded-md">

                    <div className="grid grid-cols-10 lg:grid-cols-12 2xl:grid-cols-14">
                        {
